...
import "github.com/jamestelfer/telegold/tghtmltest"

// assertTagBalanced is the R5 invariant check, applied to every block this
// package's tests render and every chunk they pack.
//
// It lives in tghtmltest because the adapter's tests assert the same property
...
var assertTagBalanced = tghtmltest.AssertTagBalanced
